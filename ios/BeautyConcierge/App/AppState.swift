...
final class AppState: ObservableObject {
    ...
    private static func recommendationsResponse(from products: [RecommendationProduct], explanation: String) -> RecommendationsResponse {
    ...
    private static func uniqueProducts(_ products: [RecommendationProduct]) -> [RecommendationProduct] {
        var seen: Set<String> = []
    ...
    private static func uniqueSkus(_ skus: [String]) -> [String] {
        var seen: Set<String> = []
    ...
    private static func selectionNotice(added: Int, duplicates: Int) -> String? {
    ...
    private static func isExecutableAdvisorAction(_ type: String) -> Bool {
        [
            "add_products",
